...
def add_bin_metrics(bins, contig_info, contamination_weigth, n=1000, threads=1):
    ...
    #     assess_bins_quality(chunk_bins, contig_to_kegg_counter, contig_to_cds_count,
    #   contig_to_aa_counter, contig_to_aa_length, postProcessor)
    return bins
...
def assess_bins_quality(
    ...
    ) - 1  # -1 = without name TODO a bit ugly - maybe just calculate length on setup somewhere
